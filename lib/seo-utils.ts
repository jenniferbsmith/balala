...
export function generateStructuredData(pageType: string = 'website', additionalData: any = {}) {
  const baseStructuredData = {
    ...
    '@graph': [
      ...
      seoConfig.schema.creativeWork,
      seoConfig.schema.howTo
    ]
  };
...
export function generateSitemapData() {
  const pages = [
    ...
    { url: '/examples', priority: 0.9, changeFreq: 'weekly' },
    { url: '/gallery', priority: 0.9, changeFreq: 'weekly' },
    { url: '/how-to-create-text-behind-image', priority: 0.85, changeFreq: 'weekly' },
    { url: '/text-behind-image-generator', priority: 0.85, changeFreq: 'weekly' },
    { url: '/ai-photo-editor', priority: 0.8, changeFreq: 'weekly' },
    { url: '/background-removal-tool', priority: 0.8, changeFreq: 'weekly' },
    { url: '/contact', priority: 0.7, changeFreq: 'monthly' },
    { url: '/about', priority: 0.7, changeFreq: 'monthly' },
    { url: '/blog', priority: 0.75, changeFreq: 'daily' },
    { url: '/tutorials', priority: 0.8, changeFreq: 'weekly' },
    { url: '/features', priority: 0.75, changeFreq: 'weekly' },
